...
config.runtimeDataModel = JSON.parse(
  '{"models":{"DirectoryEntry":{"fields":[{"name":"id","kind":"scalar","type":"String"},{"name":"name","kind":"scalar","type":"String"},{"name":"email","kind":"scalar","type":"String"},{"name":"tags","kind":"scalar","type":"String"}],"dbName":null}},"enums":{},"types":{}}',
);
...
export interface PrismaClientConstructor {
   ...
   * // Fetch zero or more DirectoryEntries
...
> {
  ...
  /**
   * `prisma.directoryEntry`: Exposes CRUD operations for the **DirectoryEntry** model.
   * Example usage:
   * ```ts
   * // Fetch zero or more DirectoryEntries
   * const directoryEntries = await prisma.directoryEntry.findMany()
   * ```
   */
  get directoryEntry(): Prisma.DirectoryEntryDelegate<ExtArgs, { omit: OmitOpts }>;
}
